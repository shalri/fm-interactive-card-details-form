    ...
    <header className="relative sm:-ml-4 sm:h-[558px] sm:py-4">
      <section
        ...
        <motion.div
          ...
          className="absolute z-20 -mt-[66px] h-[160px] w-[286px] rounded bg-[url(/images/bg-card-front.png)] bg-contain bg-no-repeat px-5 py-[18px] sm:relative sm:order-first sm:mt-0 sm:h-[246px] sm:w-[446px] sm:-ml-[92px] sm:px-8 sm:py-7 overflow-hidden sm:rounded-lg"
        >
